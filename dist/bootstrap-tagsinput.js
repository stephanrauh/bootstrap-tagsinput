...
(function($) {
  ...
  function TagsInput(element, options) {
    ...
    var bootstrapClasses = ['col-', 'form-control', 'offset-', 'visible-', 'hidden-'];
    classList.forEach(function(c) {
      if (c) {
        bootstrapClasses.forEach(function(bc) {
          if (c.startsWith(bc)) {
            thatContainer.addClass(c);
            clone.removeClass(c);
          }
        });
      }
    ...
    this.$input = clone.appendTo(this.$container);
